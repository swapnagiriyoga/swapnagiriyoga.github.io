...
export const en = {
  ...
  instructor: {
    ...
    body: 'With eight+ years of teaching and experience across all ages for fitness and wellbeing, she works patiently and without hurry: postures adapted and modified to a person’s health needs where needed, and the pace set by breath and calmness.',
  },
  ...
  programmes: {
    ...
    items: [
      ...
      {
        title: 'Regular Yoga',
        body: 'In this programme, sessions run from beginner through to intermediate. You start wherever you arrive, the sequences build from there, and the practice settles into a regular weekly rhythm.',
      },
      {
        title: 'Yoga for Kids',
